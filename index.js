...
`;
    ...
    const cleanBlobString = removeDiacritics(blobString);
    const contentDispositionHeader = 'attachment; filename="' + fixedFilename + '"';
    return new Response(cleanBlobString, { headers: { 'Content-Type': type, 'Content-Disposition': contentDispositionHeader} });
  } catch (error) {
...
// Airlifted from https://stackoverflow.com/a/5960592
